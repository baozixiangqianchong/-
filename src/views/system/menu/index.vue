...
const rules = reactive({
  ...
  qqlj: [{ required: true, message: "请输入请求路径", trigger: "blur" }],
  qqff: [{ required: true, message: "请输入请求方法", trigger: "blur" }],
});
    ...
    .then(() => {
      ...
      if (menuId) {
        ...
        getMenuForm(menuId).then(({ data }) => {
          ...
          formData.qqff = formData.request_method;
          formData.qqlj = formData.request_url;
...
function submitForm() {
  menuFormRef.value.validate((isValid: boolean) => {
    if (isValid) {
      ...
      let obj = { MENU: 1, CATALOG: 2, EXTLINK: 3, BUTTON: 4 };
      formData.type = obj[formData.type];
      formData.parent_id = formData.parentId;
      formData.request_url = formData.qqlj;
      formData.request_method = formData.qqff;
      if (menuId) {
    ...
    >
      ...
      >
        ...
        <el-form-item label="请求路径" prop="qqlj">
          <el-input
            v-model="formData.qqlj"
            placeholder="请输入请求路径，如：/app/user"
          />
        </el-form-item>
        <el-form-item label="请求方法" prop="qqff">
          <el-input
            v-model="formData.qqff"
            placeholder="请输入请求方法,如：GET,POST"
          />
        </el-form-item>
      </el-form>
